...
const AddCar = () => {
  ...
  const handleFormSubmit = async (e) => { // Event object receive korbe
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 mt-20 mb-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl w-full bg-[#101228] p-8 rounded-lg shadow-xl border border-gray-200">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-7"> {/* onSubmit direct handleFormSubmit ke call korbe */}
          {/* Car Name */}
          <div>
            <label
              htmlFor="carName"
          ...
          <div>
            ...
            <select
              ...
              } bg-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out`}
            >
